...
const SEHIRLER = ['İstanbul', 'Antalya', 'İzmir','Antalya','Bursa','Adana','Gaziantep','Konya','Kocaeli','Sakarya'];
          ...
          >
            ...
            <div className="rounded-[20px] bg-navy/85 ring-1 ring-white/10 p-5 sm:p-6">
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                {/* Tedavi */}
                <div className="sm:flex-[3_1_0%] rounded-xl bg-white/5 ring-1 ring-white/10 px-4 py-3">
                ...
                {/* Şehir */}
                <div className="sm:flex-[2_1_0%] rounded-xl bg-white/5 ring-1 ring-white/10 px-4 py-3">
                ...
                <button
                  onClick={() => paketBul()}
                  className="sm:flex-none group inline-flex items-center justify-center gap-1.5 rounded-xl bg-amber-500 px-6 py-3 text-sm font-bold text-navy glow-gold transition hover:bg-amber-400"
                >
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
              <div>
                ...
                <p className="mt-0.5 text-sm text-white/50">
                  {tr ? 'Haftalık sağlık turizmi haberleri ve özel fırsatlar.' : 'Weekly health tourism news and exclusive deals.'}
                </p>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-white/55">
                {[
                  ...
                  tr ? 'Blog'       : 'Blog',
                  tr ? 'Basın'      : 'Press',
                  tr ? 'Ortaklar'   : 'Partners',
                  tr ? 'Yatırımcılar': 'Investors',
                ].map(l => (
            ...
            <div>
              ...
              <div className="mt-7 space-y-2 text-sm text-white/40">
                <p className="flex items-center gap-2">
                  <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6A2 2 0 0 1 2.11 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
                  +90 212 000 00 00
                </p>
                <p className="flex items-center gap-2">
                ...
                <p className="flex items-center gap-2">
                  <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2a9 9 0 0 0-9 9c0 7 9 11 9 11s9-4 9-11a9 9 0 0 0-9-9Z"/><circle cx="12" cy="11" r="3"/></svg>
                  İstanbul, Türkiye
                </p>
              </div>
            </div>
          ...
          <div className="mx-auto max-w-7xl px-6 py-6 lg:px-8">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-white/30">
              ...
              <p className="text-center">
                {tr ? 'Bu bir demo platformdur — gerçek medikal tavsiye vermez.' : 'This is a demo platform — not real medical advice.'}
              </p>
            </div>
          </div>
        </div>
